...
import { Megaphone, Zap, Clock, CheckCircle, XCircle, Brain, X, UserCheck } from "lucide-react";
...
const ACTION_COLORS = {
  ...
  winback:    "bg-purple-900/40 text-purple-300",
          ...
          {["all", "re_engage", "winback", "upsell", "retain", "nurture"].map((a) => (
            <button
              ...
              className={`px-2.5 py-1 rounded text-xs font-medium capitalize transition-colors ${
                actionFilter === a ? "bg-purple-600 text-white" : "bg-gray-800 text-gray-400 hover:text-gray-200"
              }`}
            >
              {a.replace("_", " ")}
            </button>
                  ...
                  return (
                    <tr
                      ...
                      className={`border-b border-gray-800/50 cursor-pointer hover:bg-gray-800/40 transition-colors ${
                        selected.has(cid) ? "bg-purple-900/20" : ""
                      }`}
                    >
  ...
  return (
    <div className="p-6 space-y-5">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2">
          <button
            className="flex items-center gap-2 px-3 py-2 rounded-lg bg-gray-800 border border-gray-700 text-gray-300 hover:text-white text-sm font-medium transition-colors"
